...
/**
 * Resize an OpenCV image up or down keeping the aspect ratio of the original
 * image constant and padding with specified color if necessary. See
 * https://stackoverflow.com/a/72955620.
 *
 ...
 */
void resize_and_pad(const image_t &src, image_t &dst, cv::Size new_shape,
                    int pad_color = 0);
